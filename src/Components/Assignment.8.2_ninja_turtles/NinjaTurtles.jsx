        ...
        {data.map((e, index) => (
          <div
            ...
            style={{
              width: "300px",
              height: "500px",
              backgroundColor: "#a4874c",
              margin: 10,
            }}
          >
            <h3>{e.name}</h3>
            <img src={e.img} width={"100%"} height={200} />
            <p>Toppings:</p>
            {e.pizzaToppings?.map((e) => (
              <div
                onClick={() => {
                  if (list.find((e1) => e1.name === e.name)) {
                    setError(true);
                    setTimeout(() => {
                      setError(false);
                    }, 1000);
                  ...
                  list.push({ name: e.name, image: e.img });
                  setList([...list]);
                }}
                onPointerEnter={(e) => {
